  ...
  return (
    <div className=" flex  h-[100vh] w-screen dark:bg-black lg:w-[1279px] md:w-[1242px]   sm:w-[1242px] xs:w-[1242px]  xs:h-[3000px] sm:h-[3000px] md:h-[3000px]  xl:h-[3000px]  lg:h-[3000px]  xss:w-[1242px]    z-50 relative bg-white bg-opacity-95">
      <div className=" flex flex-col h-full w-full justify-center items-center space-y-5 ">
        {change === false ? (
          <div className="flex flex-row text-black text-xl dark:text-white">
            <svg
              aria-hidden="true"
            ...
            <span class="sr-only text-black">Loading...</span> Uploading Ipfs On
            Ipfs
          </div>
        ) : null}
        {change === true ? (
          <div className="flex flex-row text-black text-xl dark:text-white space-x-2 ">
            <img className="" src="./accept.png" width={30} />
            <span class="sr-only">Loading...</span> <p>Nft Uploaded on Ipfs</p>
          </div>
        ) : null}
        ...
        {change1 === false ? (
          <div className="flex flex-row text-black text-xl dark:text-white">
            ...
            <span class="sr-only text-black">Loading...</span> Developing Smart
            Contract
          </div>
        ) : null}
        ...
        {change2 === false ? (
          <div className="flex flex-row text-black text-xl dark:text-white">
            ...
            <span class="sr-only text-black">Loading...</span> Deploying Smart
            Contract
          </div>
        ) : null}
        {change2 === true ? (

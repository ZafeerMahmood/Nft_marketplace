      ...
      <div className="flex flex-col justify-center items-center ">
        <div className=" flex flex-col max-h-fit w-4/5 items-center justify-center  mt-11">
          ...
          <div className="text-base font-medium dark:text-gray-200 text-gray-600 space-y-5">
            ...
            <p>{"1. Arts"}</p>
            <p>{"2. GIFs"}</p>
            <p>{"3. Videos and sports activities highlights"}</p>
            <p>{"4. Designer Sneakers"}</p>
            <p>{"5. Virtual avatars and online game skins"}</p>
            <p>{"6. Collectibles "}</p>
            <p>{"7. Music"}</p>
            <p>{"What is the usage of an NFT: "}</p>
            <p>
              {

      ...
      <div className="flex flex-col h-full w-3/5  justify-center  ">
        <div className="flex flex-col  w-full h-60 items-center  justify-between ">
          <div className="flex flex-col h-fit w-fit xs:mt-14 sm:mt-14">
            <button
              className=" input rounded-md h-10 w-80 min   border border-double bg-[#4285F4] hover:bg-[#5893f1]   text-sm font-semibold  text-white items-center p-2 xs:h-8 xs:w-[164px] xs:text-xs xs:text-right xs:mt-5   "
            ...
            <span className="flex flex-row max-h-fit max-w-fit  -my-9 mx-8 xs:-ml-[0.20rem] xs:-my-7  ">
              <img src="./M.png" className="w-[32px] xs:w-[24px]"></img>
            </span>
          </div>

    ...
    <div className="flex flex-col h-20 w-full justify-center">
      <div className="flex flex-row  bg-[#131212] h-full w-full justify-evenly items-center  ">
        ...
        <div className=" text-white mx-20 flex flex-col w-[500px] h-[35px]  bg-[#333232] rounded-xl border border-transparent hover:border-gray-800 ">
          <svg
            class=" -my-1 mx-3 w-6 h-11 text-white dark:text-white"
            fill="currentColor"
            viewBox="0 0 20 20"
          ...
          <input
            type="text"
            class=" text-sm mx-12 -my-9 h-[33px] w-[450px] text-white bg-[#333232] rounded-2xl border border-transparent outline-none placeholder:text-white placeholder:text-start"
            placeholder="Search by Collection , NFT or User"
          />
        </div>
        <button className=" flex flex-row w-[450px] h-[30px] bg-transparent text-white font-medium text-base hover:animate-pulse">
          Explore
        </button>
        <button className=" flex flex-row w-[450px] h-[30px] bg-transparent text-white font-medium text-base hover:animate-pulse">
          Drops
        ...
        <button className=" -my-2 mx-20  relative flex flex-row w-[250px] h-[30px]  bg-transparent border border-white items-center justify-center rounded-xl  text-white font-medium text-base ">
          Connect
        </button>
